...
function SiteDisabled({ title = DEFAULT_TITLE, message = DEFAULT_MESSAGE, contactEmail = '' }) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-52 h-52 pointer-events-none"
           style={{ background: 'radial-gradient(circle at 0 0, rgba(249,115,22,0.12) 0%, transparent 70%)' }} />
      <div className="absolute bottom-0 right-0 w-52 h-52 pointer-events-none"
           style={{ background: 'radial-gradient(circle at 100% 100%, rgba(249,115,22,0.10) 0%, transparent 70%)' }} />
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6"
            ...
            <span className="text-xs font-bold tracking-widest uppercase" style={{ color: '#f97316', letterSpacing: '0.12em' }}>
              Servicio suspendido
            </span>
          </div>
          ...
          {/* Message */}
          <p className="text-sm leading-relaxed mb-3 text-center" style={{ color: '#a1a1aa' }}>
            Hemos detectado un <strong className="text-zinc-200">pago pendiente</strong> asociado
            a este servicio. Para reactivar tu sitio, por favor regulariza tu cuenta con nuestro equipo.
          </p>
          <p className="text-sm leading-relaxed mb-8 text-center" style={{ color: '#71717a' }}>
            Una vez confirmado el pago, tu sitio estará disponible nuevamente en minutos.
            ...
            <div className="flex justify-center mb-7">
              <a
                ...
                style={{
                  ...
                  boxShadow: '0 4px 30px rgba(249,115,22,0.45), inset 0 1px 0 rgba(255,255,255,0.1)',
                  textDecoration: 'none',
                }}
              >
          ...
          {/* Admin note */}
          <div className="text-center px-4 py-3.5 rounded-2xl" style={{
            background: 'rgba(255,255,255,0.025)',
            border: '1px solid rgba(255,255,255,0.07)',
          }}>
            <p className="text-xs leading-relaxed" style={{ color: '#52525b' }}>
              ¿Eres el administrador? —{' '}
              <a href="/admin" style={{ color: '#f97316', textDecoration: 'underline' }}>
                Accede al panel
              </a>
        ...
        <p className="mt-6 text-xs text-center" style={{ color: '#27272a' }}>
          © {new Date().getFullYear()} MosqueraSoft · Todos los derechos reservados
        </p>
      </div>
